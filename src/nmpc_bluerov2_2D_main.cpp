...
void publishPathPoints(const std::vector<double>& point)
{
                                                         ...
                                                         int n)
{
    ...
    double a, b, c;
    std::vector<double> p1 = {contact_point.x, contact_point.y};
    ...
    // d) Generate the path points along the quadratic path between contact_point and rov_pos
